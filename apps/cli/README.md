...
Build from the workspace root with `pnpm build --filter=postplan...`. tsdown bundles the shared HTML policy into `apps/cli/bin/postplan.js`; external runtime dependencies are declared in this package.
